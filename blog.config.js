...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Liuzh', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '嘿嘿', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://liuzhangbin.com', // 网站地址
  ...
  // 鼠标跟随特效
  MOUSE_FOLLOW: process.env.NEXT_PUBLIC_MOUSE_FOLLOW || flase, // 开关
  // 这两个只有在鼠标跟随特效开启时才生效
